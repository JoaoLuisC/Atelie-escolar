...
create table if not exists public.coupons (
  ...
  -- { category_ids: [...], product_ids: [...] }; vazio = aplica a tudo
...
-- Índices de FK (review Área 3 / RLS-07) — evitam seq scan em joins e em
-- ON DELETE CASCADE/SET NULL (inclui exclusão de conta LGPD).
