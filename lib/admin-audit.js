...
const REDACT_KEYS = new Set(['password', 'factorCode', 'challengeToken', 'token', 'accessToken', 'secret']);
 ...
 */
async function logAdminAction({ req, action, targetType, targetId = null, before = null, after = null } = {}) {
  ...
  try {
    ...
    console.warn('[admin-audit] insert falhou:', err.message);
