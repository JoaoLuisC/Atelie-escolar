...
async function createPaymentPreference(items, orderId, customerEmail) {
  ...
  const preferenceData = {
    ...
    back_urls: {
      success: `${process.env.APP_URL}/downloads.html?order=${orderId}`,
      failure: `${process.env.APP_URL}/checkout.html?status=failure`,
      pending: `${process.env.APP_URL}/checkout.html?status=pending`,
    },
    auto_return: 'approved',
    statement_descriptor: 'BANNER_STORE',
  };
 ...
 */
function isPaymentApproved(paymentData) {
