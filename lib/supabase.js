...
async function supabaseRequest(pathname, options = {}) {
  ...
  const { useServiceRole = false, headers: extraHeaders, ...fetchOptions } = options;
...
const serviceRoleHelpers = {
  ...
  listTableRows: (table, options = {}) => listTableRows(table, { ...options, useServiceRole: true }),
  ...
  upsertIntoTable: (table, rows, onConflict) => upsertIntoTable(table, rows, onConflict, { useServiceRole: true }),
  updateTable: (table, filters, payload) => updateTable(table, filters, payload, { useServiceRole: true }),
  deleteFromTable: (table, filters = {}) => deleteFromTable(table, filters, { useServiceRole: true }),
};
