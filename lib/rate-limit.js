...
const RATE_LIMITS = Object.freeze({
  ...
  // Exportação de dados do titular (LGPD art. 18, V). Cada chamada monta o
  // dossiê inteiro da pessoa — pedidos, itens, assinatura, carrinhos — em
  // várias consultas ao Postgres. É ação rara por natureza (ninguém exporta
  // os próprios dados dez vezes por minuto), e sem teto vira um jeito barato
  // de fazer uma sessão roubada custar caro ao banco.
  meExportData: Object.freeze({
    bucket: 'me-export-data',
    limit: 5,
    windowSeconds: 300,
    message: 'Muitas exportações seguidas. Aguarde alguns minutos.',
  }),
