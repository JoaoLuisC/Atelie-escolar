  ...
  return {
    ...
    html: shell(
      heroBlock({
        ...
        subtitle: `Obrigada pela sua compra, ${customerName || 'cliente'}!`,
      }) +
        bodyBlock(`
...
function postPurchaseD3({ orderId, customerName, items = [] }) {
  ...
  return {
    ...
    html: shell(
      heroBlock({
        emoji: '💜',
        title: 'E aí, deu certo?',
        subtitle: `Faz uns dias que você baixou ${firstProduct}`,
      }) +
        bodyBlock(`
        <p style="font-size:15px;margin:0 0 16px;">
...
function postPurchaseD15({ customerName, category, suggestions = [] }) {
  ...
  return {
    ...
    html: shell(
      heroBlock({
        emoji: '✨',
        title: `Mais material de ${categoryLabel}`,
        subtitle: 'Selecionei pensando em você',
      }) +
        bodyBlock(`
        <p style="font-size:15px;margin:0 0 16px;">
...
function postPurchaseD45({ customerName, category, newProducts = [] }) {
  ...
  return {
    ...
    html: shell(
      heroBlock({
        emoji: '🆕',
        title: 'Chegou material novo',
        subtitle: `Selecionado para quem usa ${categoryLabel}`,
      }) +
        bodyBlock(`
        <p style="font-size:15px;margin:0 0 16px;">
          Olá ${escapeHtml(customerName || '')}!
  ...
  return {
    ...
    html: shell(
      heroBlock({
        ...
        subtitle: 'Tem cupom esperando você',
      }) +
        bodyBlock(`
        <p style="font-size:15px;margin:0 0 16px;">
          Olá ${escapeHtml(customerName || '')}!
